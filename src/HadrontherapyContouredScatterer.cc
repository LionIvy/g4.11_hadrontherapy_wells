...
physiContScattAirTube = new G4PVPlacement(0, G4ThreeVector(0., 0.,PositionPMMABoxCenter),
 ...
 for (G4int i=0;i<PMMAStepNumber;++i)   {PMMARmin[i]=AirRingRmax;}
  ...
  logicScattMotherMod-> SetVisAttributes(EmptyColor);// -> SetVisAttributes (G4VisAttributes::Invisible);//
  ...
  logicContScattAirTube-> SetVisAttributes(EmptyColor); //-> SetVisAttributes (G4VisAttributes::Invisible);
 }
