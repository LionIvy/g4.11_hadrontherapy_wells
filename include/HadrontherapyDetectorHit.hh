...
//  G4double kineticEnergy; // current energy
...
//  inline G4double GetKinEnergy()
//  {return kineticEnergy;  }

//  inline G4ThreeVector GetMomentumDirection()
...
//  inline void SetCollection(G4int xx, G4int yy, G4int zz, G4double kinEnergy)
//  {
//    xHitID = xx;
//    yHitID = yy;
//    zHitID = zz;
//    kineticEnergy = kinEnergy;
//    //momentumDirection = momDirection;
