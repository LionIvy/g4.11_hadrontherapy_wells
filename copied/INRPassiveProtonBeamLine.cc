...
#include "HadrontherapyCellDetectorConstruction.hh"
#include "HT_PetriDishDetectorConstruction.hh"
...
G4VPhysicalVolume* INRPassiveProtonBeamLine::Construct()
{
    ...
    {hadrontherapyCellDetectorConstruction = new HadrontherapyCellDetectorConstruction(physicalTreatmentRoom);}
    else if (DetType==3)
    {petriDishDetectorConstruction = new HT_PetriDishDetectorConstruction(physicalTreatmentRoom);}
    ...
    {hadrontherapyCellDetectorConstruction->InitializeDetectorROGeometry(RO,hadrontherapyCellDetectorConstruction->GetDetectorToWorldPosition());}
    else if (DetType==3)
    {petriDishDetectorConstruction->InitializeDetectorROGeometry(RO, petriDishDetectorConstruction->GetDetectorToWorldPosition());}
